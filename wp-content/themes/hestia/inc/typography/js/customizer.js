...
wp.customize( 'hestia_headings_font_size', function( value ){
    ...
    value.bind( function( to ) {
        ...
        var arraySizes = {
            ...
            size2: { selectors: 'h1,.page-header.header-small .hestia-title, .page-header.header-small .title, body:not(.woocommerce) .blog-post .section-text h1', valueDiff: 16.8 },
            size3: { selectors: '.carousel h1.hestia-title, .carousel h2.title', valueDiff: 30.8 },
            size4: { selectors: 'h2, body:not(.woocommerce) .blog-post .section-text h2', valueDiff: 0 },
            size5: { selectors: 'h3, body:not(.woocommerce) .blog-post .section-text h3', valueDiff: -10.85 },
            size6: { selectors: 'h4, .card-blog .card-title, body:not(.woocommerce) .blog-post .section-text h4', valueDiff: -18.2 },
            size7: { selectors: 'h5, body:not(.woocommerce) .blog-post .section-text h5', valueDiff: -18.9 },
            size8: { selectors: 'h6, .card-product .category, body:not(.woocommerce) .blog-post .section-text h6', valueDiff: -23.8 },
